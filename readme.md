...
🗑️ Removed duplicate records to ensure data quality.

⚠️ Addressed missing or null values in key columns.

⏱️ Standardized date and time formats for consistency.

🛠️ Engineered new features (e.g., ride duration, day of week) to enhance analysis.
